$( document ).ready(function() {
  ...
  sql.execute("SELECT the_geom, date_filed, units, address_1 FROM {{table_name}} WHERE the_geom IS NOT NULL ORDER BY date_filed ASC", {table_name: 'oakland_uds'})
      ...
      .append("circle")
       ...
       function updateCounter(index){
        ...
        if(index<1){
          ...
          document.getElementById('date').innerHTML = "1/1/2005 - " + currMonth+"/"+currDay + "/"+currDate;
