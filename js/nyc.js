$( document ).ready(function() {
  ...
  //sql.execute("SELECT the_geom, date_filed, address_1, units, type, demo_count_at_date, ellis_count_at_date, omi_count_at_date, total_count_at_date FROM ellis_2016 WHERE date_filed IS NOT NULL ORDER BY date_filed ASC", {table_name: 'ellis_updated_2_13'})
  sql.execute("SELECT the_geom, date_filed, units, address_1 FROM {{table_name}} WHERE the_geom IS NOT NULL ORDER BY date_filed ASC", {table_name: 'nyc_evictions_1'})
      ...
      .append("circle")
       ...
       function updateCounter(index){
        ...
        if(index<1){
          ...
          document.getElementById('date').innerHTML = "1/1/2017 - " + currMonth+"/"+currDay + "/"+currDate;
