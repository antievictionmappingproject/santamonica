$( document ).ready(function() {
  ...
  sql.execute("SELECT the_geom, date_filed, address_1, units, type, demo_count_at_date, ellis_count_at_date, omi_count_at_date, total_count_at_date FROM no_fault_dec_2014_with_counts WHERE date_filed IS NOT NULL ORDER BY date_filed ASC", {table_name: 'lee_evictions'})
